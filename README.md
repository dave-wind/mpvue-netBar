...
### 设计流程图
<p>
  <img alt="" src="http://s1.axhome.com.cn/screenshots/index.png" width="33%" />
  <img alt="" src="http://s1.axhome.com.cn/screenshots/permis.png" width="33%" />
  <img alt="" src="http://s1.axhome.com.cn/screenshots/main.png" width="33%" />
</p>
...
2.在mpvue里没有router每个页面需要些main.js以及接口交互最好用flyio,如果对这几点深感洁癖的追求完美的可用如下插件:      
